                    ...
                    <ul className="font-medium flex flex-col md:flex-row p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 md:dark:bg-gray-900 md:border-0 md:bg-white">
                        ...
                        <li className="md:mr-6">
                            <a
                                ...
                                className={`block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white ${activeLink === "experience" ? "bg-blue-700 text-white md:bg-transparent md:text-blue-700 md:p-0 dark:bg-blue-800 dark:text-white" : "text-gray-900 dark:hover:text-white md:dark:hover:bg-transparent"}`}
                        ...
                        <li className="md:mr-6">
                            <a
                                ...
                                className={`block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white ${activeLink === "projects" ? "bg-blue-700 text-white md:bg-transparent md:text-blue-700 md:p-0 dark:bg-blue-800 dark:text-white" : "text-gray-900 dark:hover:text-white md:dark:hover:bg-transparent"}`}
