...
export function DockDemo() {
    ...
    const handleLinkedInClick = () => {
        window.open("https://www.linkedin.com/in/embarki-omar-10651a22a/", "_blank");
    };

    const handleInstagramClick = () => {
        window.open("https://www.instagram.com/omar_embarki?utm_source=qr&igsh=MXNnYWd3d21sbTNnYQ==", "_blank");
    };
    ...
    return (
        <div className="relative">
            <Dock direction="middle">
                <DockIcon>
                    <Icons.gmail className="size-6" onClick={handleEmailClick} />
                </DockIcon>
                <DockIcon>
                    <Icons.linkedin className="size-6" onClick={handleLinkedInClick} />
                </DockIcon>
                <DockIcon>
                    <Icons.instegram className="size-6" onClick={handleInstagramClick} />
                </DockIcon>
                <DockIcon>
                    <Icons.github className="size-6" onClick={handleGitHubClick} />
                </DockIcon>
            </Dock>
        </div>
    );
